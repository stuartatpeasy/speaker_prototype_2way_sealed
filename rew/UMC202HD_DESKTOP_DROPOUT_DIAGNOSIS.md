...
worse. A UMC22 fallback is being qualified separately so this diagnosis no
longer blocks the first FRD set.
...
- [UMC22 fallback and exact current gate](UMC22_RISK_ACCEPTED_FRD_FALLBACK.md)
- [UMC202HD full-dual operating procedure](FRD_MEASUREMENT_SETUP_TEST.md)
- [Passive fixture authority](SU-V570_TO_UMC202HD_REFERENCE_FIXTURE.md)
- [Completed fixture AC release](REFERENCE_FIXTURE_AC_COMMISSIONING.md)
