...
3. Complete and record the unpowered SU-V570 common-ground checks before connecting the protected amplifier-output reference to the UMC202HD.
...
- The SU-V570 schematic strongly indicates common speaker-return ground, but external resistance readings and divider commissioning remain pending.
