# Room Geometry and Acoustic Screening

> - **Lifecycle:** CURRENT GEOMETRY EVIDENCE AND SCREENING AUTHORITY
> - **Owns:** canonical DAE provenance and hash, coordinate interpretation, detailed dimensions and coupled volumes, apertures, fixed architectural/contents geometry, boundary assumptions, screening calculations, modelling scope, and DAE history
> - **Does not own:** placement-candidate selection, listening-position measurement execution, or crossover-room correction
> - **Current decision:** treat the current local geometry as exact enough for screening; bracket uncertain boundaries and prefer measurement over further remote detail
> - **Next gate:** confirm normal opening states and listener interpretation; extend geometry only if sensitivity or low-frequency goals justify it
> - **Limitations:** the shell is not a watertight solver volume; remote openings, floor substrate, wall build-up, and several contents remain uncertain
> - **As of:** 2026-09-06

This is the detailed geometry companion to [ROOM_DETAILS.md](../ROOM_DETAILS.md). Placement alternatives and measurement work are in [ROOM_PLACEMENT_AND_MEASUREMENT.md](ROOM_PLACEMENT_AND_MEASUREMENT.md).

Status labels retained in this record:
...
## 1. Source, evidence classes, and interpretation
...
## 3. Fixed architecture, contents, and boundary assumptions

### 3.1 Window, doorway, and door
...
### 3.3 Resolved checks and remaining model notes
...
### 3.4 Provisional boundary assumptions
...
## 4. Acoustic screening and modelling scope
...
### 4.2 Model scope and diminishing returns
...
5. **Boundary build-up:** retain the provisional assumptions in Section 3.4 unless non-destructive evidence becomes available; floor substrate and ceiling/roof-void construction are more useful than destructive plasterboard inspection.
