...
| Audit the completed Seed A full-system level and thermal gate | [`qualification/SEED_A_FULL_SYSTEM_LEVEL_AND_THERMAL_QUALIFICATION_2026-09-10.md`](qualification/SEED_A_FULL_SYSTEM_LEVEL_AND_THERMAL_QUALIFICATION_2026-09-10.md) | [`../CROSSOVER_DESIGN.md`](../CROSSOVER_DESIGN.md) for the design consequence; the completed procedure only for a deliberate repeat |
| Deliberately repeat the Seed A level/thermal route or adapt it for speaker two | [`procedures/UMC22_SEED_A_LEVEL_AND_THERMAL.md`](procedures/UMC22_SEED_A_LEVEL_AND_THERMAL.md) | Fixture qualification only after a changed route or failed gate |
| Deliberately repeat Seed A impedance/phase or adapt the route for speaker two | [`procedures/STARTECH_SEED_A_SYSTEM_IMPEDANCE.md`](procedures/STARTECH_SEED_A_SYSTEM_IMPEDANCE.md) | [`../CROSSOVER_DESIGN.md`](../CROSSOVER_DESIGN.md) for the design gate; qualification only if hardware or an established gate is disputed |
...
| Plan a new measurement series or revise evidence handling | [`MEASUREMENT_PLANNING_AND_EVIDENCE.md`](MEASUREMENT_PLANNING_AND_EVIDENCE.md) | The exact current interface procedure and qualification only when a gate changes |
| Extract or compactly summarise a retained `.mdat` through REW | [`procedures/REW_MDAT_EXTRACTION.md`](procedures/REW_MDAT_EXTRACTION.md) | [`../REW_API_CLIENT.md`](../REW_API_CLIENT.md) for live status/snapshot; API validation only for maintenance or failure audit |
...
| Audit approved installed-driver acoustic sources, window choice, or a capture exclusion | [`qualification/INSTALLED_DRIVER_ACOUSTIC_SOURCES_2026-09-06_TO_07.md`](qualification/INSTALLED_DRIVER_ACOUSTIC_SOURCES_2026-09-06_TO_07.md) | [`../DRIVER_ANALYSIS.md`](../DRIVER_ANALYSIS.md) for the current modelling consequence; dated history only for superseded interface attempts |
...
- [`qualification/INSTALLED_DRIVER_ACOUSTIC_SOURCES_2026-09-06_TO_07.md`](qualification/INSTALLED_DRIVER_ACOUSTIC_SOURCES_2026-09-06_TO_07.md) — **QUALIFICATION EVIDENCE** for approved installed-driver on-axis and sparse-polar source selection, exclusions, timing, windows, and protection scale.
...
- [`qualification/SEED_A_FULL_SYSTEM_LEVEL_AND_THERMAL_QUALIFICATION_2026-09-10.md`](qualification/SEED_A_FULL_SYSTEM_LEVEL_AND_THERMAL_QUALIFICATION_2026-09-10.md) — **QUALIFICATION EVIDENCE** for the retained level series, sampled distortion, compression comparison, external-component temperatures, invalid post-thermal trace exclusion, and bounded decision.
